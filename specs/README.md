...
## Feature specs
- [`features/peg-board.md`](features/peg-board.md) — board rules, manual play.
- [`features/idle-economy.md`](features/idle-economy.md) — currency, Auto-Jumper, upgrades, offline.
