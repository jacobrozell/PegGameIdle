...
- [`system/app-shell.md`](system/app-shell.md) — **v2 draft** — tabs, sheets, timer, toasts.
- [`system/design-system.md`](system/design-system.md) — **v2 draft** — tokens, components, motion.
...
- [`features/achievements.md`](features/achievements.md) — **v2 draft** — milestones, multipliers.
- [`features/onboarding.md`](features/onboarding.md) — **v2 draft** — first-run walkthrough.
- [`features/stats-history.md`](features/stats-history.md) — **v2 draft** — lifetime stats in Awards tab.
